...
public readonly record struct Result
{
    ...
    private Result(bool isSuccess, ResultError[] errors) => (IsSuccess, Errors) = (isSuccess, errors);
    ...
    public bool Equals(Result other) => IsSuccess == other.IsSuccess && Errors.AsSpan().SequenceEqual(other.Errors);
    ...
    public static Result Failure(params ResultError[] errors) => new(isSuccess: false, errors: errors);
    ...
    public static Result BadRequest(params ResultError[] errors) => Failure(errors);

    public static Result Validation(params ResultError[] errors) => Failure(errors);
...
public readonly record struct Result<T>
{
    ...
    public bool Equals(Result<T> other) =>
        IsSuccess == other.IsSuccess && EqualityComparer<T>.Default.Equals(
            Value,
            other.Value
    ...
    // Multi-errors where several failures can surface at once
    public static Result<T> BadRequest(params ResultError[] errors) => Failure(errors);
    public static Result<T> Validation(params ResultError[] errors) => Failure(errors);
    ...
    public Result<TResult> Map<TResult>(Func<T, TResult> map) =>
        IsSuccess ? Result<TResult>.Success(map(Value!)) : Result<TResult>.Failure(Errors);
    ...
    public Result<TResult> Bind<TResult>(Func<T, Result<TResult>> next) =>
        IsSuccess ? next(Value!) : Result<TResult>.Failure(Errors);
