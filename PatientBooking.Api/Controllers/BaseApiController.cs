...
public abstract class BaseApiController : ControllerBase
{
    ...
    protected ObjectResult MapErrorsToResponse(ResultError[] errors)
    {
        ...
        return e.Code switch
        {
            ...
            nameof(ErrorCodes.BadRequest) => Problem(detail: e.Description, statusCode: StatusCodes.Status400BadRequest),
            nameof(ErrorCodes.Validation) => Problem(detail: e.Description, statusCode: StatusCodes.Status400BadRequest),
            ...
            nameof(ErrorCodes.Unprocessable) => Problem(detail: e.Description, statusCode: StatusCodes.Status422UnprocessableEntity),
            nameof(ErrorCodes.Unauthorized) => Problem(detail: e.Description, statusCode: StatusCodes.Status401Unauthorized),
