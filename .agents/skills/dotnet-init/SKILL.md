...
Interactively initializes a .NET project for use with dotnet-Codex-kit. Detects the project type, asks targeted questions about architecture and tech stack, then generates a fully customized `AGENTS.md` in the project root.

**No manual template copying required.**

## When

- Starting a new .NET project with Codex
- Adding dotnet-Codex-kit to an existing project
- "init project", "setup project", "generate AGENTS.md", "configure for dotnet-Codex-kit"
...
Codex: No .sln or .csproj found. Let's set up a new project.
