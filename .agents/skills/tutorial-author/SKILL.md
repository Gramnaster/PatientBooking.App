...
/ C# Obsidian vault (`Ultimate-ASPNET-Core-Web-API/AGENTS.md`) — that file is a live example of
...
Codex: Loading references/staged-challenge.md. Stage 1 grounds the reader in
...
- `Ultimate-ASPNET-Core-Web-API/AGENTS.md` — the ASP.NET/C#-pinned precedent this skill
