...
and Codex explicitly agree on — before any planning or code. The contract:

- **Never assume.** Every gap in the idea becomes a question. If Codex catches
...
Take the raw idea and restate it in one paragraph: what Codex understood, in its
...
Codex: Here's what I understood: an existing user can invite another person
...
Codex: Round 2 — Edge cases (your "both" in Q1 raises these):
...
Codex: Spec written to docs/specs/004-team-invitations.md (In Review).
  Read it end-to-end. What is wrong, missing, or over-engineered?

User: looks right. approved.

Codex: Status: Approved (2026-06-12). Next: /plan to map AC-1..AC-9
